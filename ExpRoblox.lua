...
end)local c= e:Window("KOBEN Hub","11354741327")local e= c:Tab("Main","rbxassetid://6026568198")local f= c:Tab("Main 2","rbxassetid://16327363662")local g= c:Tab("Player/Stats","rbxassetid://16327363662")local h= c:Tab("Combat","rbxassetid://7251993295")local i= c:Tab("Teleport/Sv","rbxassetid://16327363662")local j= c:Tab("Raid","rbxassetid://7044284832")local k= c:Tab("Devil Fruit","rbxassetid://16327363662")local l= c:Tab("Shop","rbxassetid://16327363662")local c= c:Tab("Misc","rbxassetid://16327363662")e:Seperator("Settings")e:Button("Copy Link Discord Server",function()
    setclipboard("Ko có
